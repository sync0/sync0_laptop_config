(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (doom-modeline minions org-plus-contrib flycheck-pos-tip flycheck interleave mu4e-alert mu4e-conversation git-timemachine gnuplot gnuplot-mode magit avy yasnippet diff-hl highlight-indentation highlight-numbers rainbow-delimiters smartparens git-gutter ivy-bibtex lisp-mode hl-line-mode diminish font-lock+ fancy-battery dim evil-escape calfw-cal calfw-org calfw-gcal calfw org-gcal request visual-fill-column hlinum doom-themes solaire-mode eldoc-eval use-package evil-multiedit iedit anzu evil-anzu powerline all-the-icons all-the-icons-ivy ess auctex org ivy smooth-scrolling org-ref projectile org-bullets evil counsel)))
