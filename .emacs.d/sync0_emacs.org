   ...
   (use-package custom
    ...
    (custom-theme-set-faces 'user
                            ...
                            `(org-link ((t (:inherit org-default :underline t))))
                             `(org-block-begin-line ((t (:inherit org-default :family "Fira Code" :height 0.75 :background nil))))
                             `(org-block-end-line ((t (:inherit org-default :family "Fira Code" :height 0.75 :background nil))))
                             `(org-block ((t (:inherit org-default :family "Fira Code" :height 0.75 :background nil))))
  ...
  (add-hook 'before-save-hook (lambda ()
                                (when (and (eq major-mode 'org-mode)
                                           (or (equal default-directory (concat (getenv "HOME") "/Dropbox/org/"))
                                               ...
                                               (equal default-directory (concat (getenv "HOME") "/Dropbox/org/messages/"))
