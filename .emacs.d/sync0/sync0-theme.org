...
;; Man should not be ready to
;; show that he can live like a badly-fed animal. He should decline
;; to live like that, and should either steal or go on the rates,
;; which is considered by many to be a form of stealing. As for
...
;; enemy, and sold their birthright for very bad pottage. 
;;
;; Oscar Wilde
